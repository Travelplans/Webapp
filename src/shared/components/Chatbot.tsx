        ...
        <>
            ...
            {isOpen && (
                <>
                    ...
                    />
                    {/* Chatbot Modal */}
                    <div className="fixed bottom-24 right-6 w-[90vw] sm:w-96 max-w-sm h-[70vh] max-h-[600px] bg-white rounded-xl shadow-2xl flex flex-col z-50 overflow-hidden animate-toast-in">
